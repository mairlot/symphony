...
public class DelegatedCmlBehaviour implements CmlBehaviour
{
	...
	public DelegatedCmlBehaviour(INode node, Context context, CmlBehaviour parent, BehaviourName name,
			...
			throws AnalysisException
	{
		try
		{
			if(selectedTransition instanceof AbstractSilentTransition || selectedTransition instanceof TimedTransition)
			{
				return;
			}
	...
	public static void setEventSources(CmlTransition t, DelegatedCmlBehaviour delegatedCmlBehaviour)
	...
	public static void setEventSources(CmlTransition t, SortedSet<CmlBehaviour> eventSources)
			throws IllegalAccessException
	{
